"use strict";(()=>{var e={};e.id=473,e.ids=[473],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},7702:e=>{e.exports=require("events")},2048:e=>{e.exports=require("fs")},2615:e=>{e.exports=require("http")},8791:e=>{e.exports=require("https")},5315:e=>{e.exports=require("path")},8621:e=>{e.exports=require("punycode")},6162:e=>{e.exports=require("stream")},5346:e=>{e.exports=require("timers")},7360:e=>{e.exports=require("url")},1764:e=>{e.exports=require("util")},2623:e=>{e.exports=require("worker_threads")},1568:e=>{e.exports=require("zlib")},8678:e=>{e.exports=import("pg")},7561:e=>{e.exports=require("node:fs")},4492:e=>{e.exports=require("node:stream")},2477:e=>{e.exports=require("node:stream/web")},9476:(e,t,r)=>{r.a(e,async(e,a)=>{try{r.r(t),r.d(t,{originalPathname:()=>d,patchFetch:()=>l,requestAsyncStorage:()=>h,routeModule:()=>u,serverHooks:()=>p,staticGenerationAsyncStorage:()=>m});var s=r(9303),o=r(8716),n=r(670),i=r(445),c=e([i]);i=(c.then?(await c)():c)[0];let u=new s.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/refresh/route",pathname:"/api/refresh",filename:"route",bundlePath:"app/api/refresh/route"},resolvedPagePath:"/Users/edwardesslemont/Desktop/Claude/News/app/app/api/refresh/route.js",nextConfigOutput:"",userland:i}),{requestAsyncStorage:h,staticGenerationAsyncStorage:m,serverHooks:p}=u,d="/api/refresh/route";function l(){return(0,n.patchFetch)({serverHooks:p,staticGenerationAsyncStorage:m})}a()}catch(e){a(e)}})},445:(e,t,r)=>{r.a(e,async(e,a)=>{try{r.r(t),r.d(t,{POST:()=>c});var s=r(8492),o=r(4943),n=r(4191),i=e([n]);async function c(){try{await (0,n.Dv)();let e=await (0,n.fY)();if(e?.createdAt&&(Date.now()-new Date(e.createdAt).getTime())/36e5<4){let t=new Date(new Date(e.createdAt).getTime()+144e5);return Response.json({error:"too_soon",nextRefreshAt:t},{status:429})}let t=await (0,s.S)();if(Object.values(t).flat().length<10)return Response.json({error:"Too few headlines fetched"},{status:500});let r=await (0,o.O)(t),a=(0,n.s6)();return await (0,n.GZ)(a,r),await (0,n.eP)(),Response.json({success:!0,count:r.length})}catch(e){return console.error("Refresh failed:",e),Response.json({error:e.message},{status:500})}}n=(i.then?(await i)():i)[0],a()}catch(e){a(e)}})},4943:(e,t,r)=>{r.d(t,{O:()=>n});let a=new(r(4588)).ZP({apiKey:process.env.ANTHROPIC_API_KEY}),s={authLeft:{label:"Progressive Governance",color:"#7965B2",bgColor:"#F7F5FD",borderColor:"#D8D0F0"},authRight:{label:"Conservative Governance",color:"#C47B3C",bgColor:"#FCF6EE",borderColor:"#EDD8B8"},libLeft:{label:"Egalitarian Anti-Establishment",color:"#4A82B0",bgColor:"#EFF6FC",borderColor:"#C0DDF0"},libRight:{label:"Free-Market Libertarian",color:"#4E8E80",bgColor:"#EFF8F6",borderColor:"#B8DDD8"}},o={authLeft:"PROGRESSIVE GOVERNANCE SOURCES",authRight:"CONSERVATIVE GOVERNANCE SOURCES",libLeft:"EGALITARIAN ANTI-ESTABLISHMENT SOURCES",libRight:"FREE-MARKET LIBERTARIAN SOURCES",general:"TECH / BUSINESS / CULTURE SOURCES"};async function n(e){let t;let r=Object.entries(e).map(([e,t])=>{let r=o[e]||e.toUpperCase(),a=t.map(e=>`  - [${e.source}] ${e.title}`).join("\n");return`${r}:
