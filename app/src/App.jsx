      ...
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "0 24px 80px" }}>
        {!story ? (
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 16 }}>
                    <div style={{ flex: 1 }}>
                      <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 10 }}>
                        ...
                        <span style={{ fontFamily: "'Inter', sans-serif", fontSize: 11, color: "#b0aba5" }}>{s.time} · {s.date}</span>
                      </div>
          ...
          <div>
            ...
            <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "clamp(22px, 3.5vw, 34px)", fontWeight: 700, lineHeight: 1.25, marginBottom: 10, maxWidth: 680, color: "#1a1916" }}>{story.headline}</h2>
            <div style={{ fontFamily: "'Inter', sans-serif", fontSize: 11, color: "#b0aba5", marginBottom: 20 }}>{story.time} · {story.date}</div>
